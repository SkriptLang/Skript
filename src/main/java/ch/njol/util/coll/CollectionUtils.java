...
public abstract class CollectionUtils {
	 ...
	 * @return The passed array
	 */
	public static <T> T[] arrayOf(Class<? super T> type, Object... array) {
		Object created = Array.newInstance(type, array.length);
		//noinspection SuspiciousSystemArraycopy
		System.arraycopy(array, 0, created, 0, array.length);
