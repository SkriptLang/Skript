...
/**
 * @deprecated Regular {@link org.skriptlang.skript.lang.structure.Structure} methods should be used. (Removal 2.13.0)
...
public abstract class SelfRegisteringSkriptEvent extends SkriptEvent {
	 ...
	 * @deprecated This method's functionality can be replaced by overriding {@link #postLoad()}. (Removal 2.13.0)
	 ...
	 * @deprecated This method's functionality can be replaced by overriding {@link #unload()}. (Removal 2.13.0)
	 ...
	 * @deprecated This method should no longer be used. (Removal 2.13.0)
	 ...
	 * @deprecated Use {@link #postLoad()} instead. (Removal 2.13.0)
	 */
	@Deprecated(forRemoval = true)
