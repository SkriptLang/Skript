	...
	public List<MessageComponent> getMessageComponents(Event e) {
		...
		for (MessageComponent component : components) {
			if (component == null) { // This component holds place for variable part
				...
				String text = null;
				if (o instanceof ExprColored && ((ExprColored) o).isUnsafeFormat()) { // Special case: user wants to process formatting
					String unformatted = Classes.toString(((ExprColored) o).getArray(e), true, mode);
					if (unformatted != null) {
