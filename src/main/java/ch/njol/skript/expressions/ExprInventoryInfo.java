...
public class ExprInventoryInfo extends SimpleExpression<Object> {
	...
	static {
		Skript.registerExpression(ExprInventoryInfo.class, Object.class, ExpressionType.PROPERTY,
				"(" + HOLDER + "¦holder[s]|" + VIEWERS + "¦viewers|" + ROWS + "¦[amount of] rows|" + SLOTS + "¦([amount of] slots|inventory size))" + " of %inventories%",
				"%inventories%'[s] (" + HOLDER + "¦holder[s]|" + VIEWERS + "¦viewers|" + ROWS + "¦[amount of] rows|" + SLOTS + "¦([amount of] slots|inventory size))"
		);
	}
