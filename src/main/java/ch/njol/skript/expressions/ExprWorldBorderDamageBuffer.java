...
@Description("The amount of blocks a player may safely be outside the border before taking damage.")
...
public class ExprWorldBorderDamageBuffer extends SimplePropertyExpression<WorldBorder, Double> {
	...
	static {
		register(ExprWorldBorderDamageBuffer.class, Double.class, "[border] damage buffer", "worldborders");
	}
