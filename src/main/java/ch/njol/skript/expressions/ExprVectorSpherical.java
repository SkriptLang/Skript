...
@Since("2.2-dev28")
public class ExprVectorSpherical extends SimpleExpression<Vector3d> {

	private static final double DEG_TO_RAD = Math.PI / 180;

	static {
		Skript.registerExpression(ExprVectorSpherical.class, Vector3d.class, ExpressionType.SIMPLE,
	...
	public static Vector3d fromSphericalCoordinates(double radius, double theta, double phi) {
