...
//						return t.start + "-" + t.end;
		...
		Classes.registerClass(new ClassInfo<>(Date.class, "date")
				.user("dates?")
				.name("Date")
				.description("A date is a certain point in the real world's time which can be obtained with <a href='./expressions.html#ExprNow'>now</a>, <a href='./expressions.html#ExprUnixDate'>unix date</a> and <a href='./functions.html#date'>date()</a>.",
