...
public final class BukkitEventValues {
	...
	static {
		...
		EventValues.registerEventValue(BlockPlaceEvent.class, Block.class, e -> new BlockStateBlock(e.getBlockReplacedState()), TIME_PAST);
		EventValues.registerEventValue(BlockPlaceEvent.class, Direction.class, e -> {
		...
		EventValues.registerEventValue(BlockFadeEvent.class, Block.class, e -> new DelayedChangeBlock(e.getBlock(), e.getNewState()));
		EventValues.registerEventValue(BlockFadeEvent.class, Block.class, e -> new BlockStateBlock(e.getNewState()), TIME_FUTURE);
		// BlockGrowEvent (+ BlockFormEvent)
		EventValues.registerEventValue(BlockGrowEvent.class, Block.class, e -> new BlockStateBlock(e.getNewState()));
		...
		EventValues.registerEventValue(BlockBreakEvent.class, Block.class, e -> new DelayedChangeBlock(e.getBlock()));
		EventValues.registerEventValue(BlockBreakEvent.class, Block.class, e -> {
		...
		EventValues.registerEventValue(BlockCanBuildEvent.class, Block.class, e -> {
			final BlockState s = e.getBlock().getState();
		...
		// === EntityEvents ===
		EventValues.registerEventValue(EntityEvent.class, Entity.class, EntityEvent::getEntity, 0, "Use 'attacker' and/or 'victim' in damage/death events", EntityDamageEvent.class, EntityDeathEvent.class);
		EventValues.registerEventValue(EntityEvent.class, CommandSender.class, EntityEvent::getEntity, 0, "Use 'attacker' and/or 'victim' in damage/death events", EntityDamageEvent.class, EntityDeathEvent.class);
		EventValues.registerEventValue(EntityEvent.class, World.class, e -> e.getEntity().getWorld());
		EventValues.registerEventValue(EntityEvent.class, Location.class, e -> e.getEntity().getLocation());
		// EntityDamageEvent
		EventValues.registerEventValue(EntityDamageEvent.class, DamageCause.class, EntityDamageEvent::getCause);
		EventValues.registerEventValue(EntityDamageByEntityEvent.class, Projectile.class, e -> {
		...
		EventValues.registerEventValue(EntityDeathEvent.class, Projectile.class, e -> {
		...
		EventValues.registerEventValue(EntityDeathEvent.class, DamageCause.class, e -> {
			final EntityDamageEvent ldc = e.getEntity().getLastDamageCause();
		...
		EventValues.registerEventValue(ProjectileHitEvent.class, Entity.class, e -> {
			assert false;
			return e.getEntity();
		...
		if (Skript.methodExists(ProjectileHitEvent.class, "getHitBlockFace")) {
			EventValues.registerEventValue(ProjectileHitEvent.class, Direction.class, e -> {
		...
		EventValues.registerEventValue(ProjectileLaunchEvent.class, Entity.class, e -> {
			assert false;
			return e.getEntity();
		...
		EventValues.registerEventValue(AreaEffectCloudApplyEvent.class, LivingEntity[].class, event -> event.getAffectedEntities().toArray(new LivingEntity[0]));
		EventValues.registerEventValue(AreaEffectCloudApplyEvent.class, PotionEffectType.class, new Converter<>() {
			...
			@Override
			public PotionEffectType convert(AreaEffectCloudApplyEvent e) {
		...
		// ItemSpawnEvent
		EventValues.registerEventValue(ItemSpawnEvent.class, ItemStack.class, e -> e.getEntity().getItemStack());
		...
		EventValues.registerEventValue(PlayerEvent.class, World.class, e -> e.getPlayer().getWorld());
		// PlayerBedEnterEvent
		...
		EventValues.registerEventValue(PlayerBucketFillEvent.class, Block.class, e -> {
			final BlockState s = e.getBlockClicked().getState();
			s.setType(Material.AIR);
			s.setRawData((byte) 0);
			return new BlockStateBlock(s, true);
		}, TIME_FUTURE);
		EventValues.registerEventValue(PlayerBucketEmptyEvent.class, Block.class, e -> e.getBlockClicked().getRelative(e.getBlockFace()), TIME_PAST);
		EventValues.registerEventValue(PlayerBucketEmptyEvent.class, Block.class, e -> {
		...
		EventValues.registerEventValue(PlayerDropItemEvent.class, ItemStack.class, e -> e.getItemDrop().getItemStack());
		// EntityDropItemEvent
		...
		EventValues.registerEventValue(PlayerPickupItemEvent.class, ItemStack.class, e -> e.getItem().getItemStack());
		...
		EventValues.registerEventValue(EntityPickupItemEvent.class, ItemType.class, e -> new ItemType(e.getItem().getItemStack()));
		...
		EventValues.registerEventValue(PlayerInteractEntityEvent.class, ItemStack.class, e -> {
		...
		EventValues.registerEventValue(PlayerInteractEvent.class, Direction.class, e -> new Direction(new double[]{e.getBlockFace().getModX(), e.getBlockFace().getModY(), e.getBlockFace().getModZ()}));
		// PlayerShearEntityEvent
		EventValues.registerEventValue(PlayerShearEntityEvent.class, Entity.class, PlayerShearEntityEvent::getEntity);
		// PlayerMoveEvent
		EventValues.registerEventValue(PlayerMoveEvent.class, Block.class, event -> event.getTo().clone().subtract(0, 0.5, 0).getBlock());
		...
		EventValues.registerEventValue(HangingEvent.class, World.class, e -> e.getEntity().getWorld());
		EventValues.registerEventValue(HangingEvent.class, Location.class, e -> e.getEntity().getLocation());

		// HangingBreakEvent
		EventValues.registerEventValue(HangingBreakEvent.class, Entity.class, e -> {
		...
		EventValues.registerEventValue(VehicleEvent.class, World.class, e -> e.getVehicle().getWorld());
		...
		EventValues.registerEventValue(VehicleEvent.class, Entity.class, e -> e.getVehicle().getPassenger());
		...
		EventValues.registerEventValue(ScriptEvent.class, CommandSender.class, e -> Bukkit.getConsoleSender());
		// Server load event
		EventValues.registerEventValue(SkriptStartEvent.class, CommandSender.class, e -> Bukkit.getConsoleSender());
		// Server stop event
		EventValues.registerEventValue(SkriptStopEvent.class, CommandSender.class, e -> Bukkit.getConsoleSender());

		// === InventoryEvents ===
		// InventoryClickEvent
		EventValues.registerEventValue(InventoryClickEvent.class, Player.class, e -> e.getWhoClicked() instanceof Player ? (Player) e.getWhoClicked() : null);
		EventValues.registerEventValue(InventoryClickEvent.class, World.class, e -> e.getWhoClicked().getWorld());
		EventValues.registerEventValue(InventoryClickEvent.class, ItemStack.class, e -> {
			if (e instanceof CraftItemEvent)
				return ((CraftItemEvent) e).getRecipe().getResult();
			return e.getCurrentItem();
		});
		EventValues.registerEventValue(InventoryClickEvent.class, Slot.class, e -> {
		...
		// InventoryDragEvent
		EventValues.registerEventValue(InventoryDragEvent.class, Player.class, event -> event.getWhoClicked() instanceof Player ? (Player) event.getWhoClicked() : null);
		...
		EventValues.registerEventValue(InventoryDragEvent.class, ItemStack[].class, event -> event.getNewItems().values().toArray(new ItemStack[0]));
		...
		EventValues.registerEventValue(PrepareItemCraftEvent.class, Slot.class, e -> new InventorySlot(e.getInventory(), 0));
		EventValues.registerEventValue(PrepareItemCraftEvent.class, ItemStack.class, e -> {
		...
		EventValues.registerEventValue(PrepareItemCraftEvent.class, Player.class, e -> {
		...
		EventValues.registerEventValue(CraftItemEvent.class, String.class, e -> {
			Recipe recipe = e.getRecipe();
			if (recipe instanceof Keyed)
				return ((Keyed) recipe).getKey().toString();
			return null;
		});
		EventValues.registerEventValue(PrepareItemCraftEvent.class, String.class, e -> {
			Recipe recipe = e.getRecipe();
			if (recipe instanceof Keyed)
				return ((Keyed) recipe).getKey().toString();
			return null;
		...
		// CraftItemEvent
		EventValues.registerEventValue(CraftItemEvent.class, ItemStack.class, e -> e.getRecipe().getResult());
		//InventoryOpenEvent
		EventValues.registerEventValue(InventoryOpenEvent.class, Player.class, e -> (Player) e.getPlayer());
		EventValues.registerEventValue(InventoryOpenEvent.class, Inventory.class, InventoryEvent::getInventory);
		//InventoryCloseEvent
		EventValues.registerEventValue(InventoryCloseEvent.class, Player.class, e -> (Player) e.getPlayer());
		...
		EventValues.registerEventValue(PlayerEditBookEvent.class, String[].class, event -> event.getPreviousBookMeta().getPages().toArray(new String[0]), TIME_PAST);
		EventValues.registerEventValue(PlayerEditBookEvent.class, String[].class, event -> event.getNewBookMeta().getPages().toArray(new String[0]));
		//ItemDespawnEvent
		EventValues.registerEventValue(ItemDespawnEvent.class, Item.class, ItemDespawnEvent::getEntity);
		EventValues.registerEventValue(ItemDespawnEvent.class, ItemStack.class, e -> e.getEntity().getItemStack());
		//ItemMergeEvent
		...
		EventValues.registerEventValue(ItemMergeEvent.class, ItemStack.class, e -> e.getEntity().getItemStack());
		//PlayerTeleportEvent
		...
		EventValues.registerEventValue(FireworkExplodeEvent.class, FireworkEffect.class, e -> {
		...
		EventValues.registerEventValue(EnchantItemEvent.class, EnchantmentType[].class, event -> event.getEnchantsToAdd().entrySet().stream()
		...
		if (Skript.classExists("io.papermc.paper.event.player.PlayerStopUsingItemEvent")) {
			EventValues.registerEventValue(PlayerStopUsingItemEvent.class, Timespan.class, event -> new Timespan(Timespan.TimePeriod.TICK, event.getTicksHeldFor()));
			EventValues.registerEventValue(PlayerStopUsingItemEvent.class, ItemType.class, event -> new ItemType(event.getItem()));
		}
		...
		// PlayerItemHeldEvent
		EventValues.registerEventValue(PlayerItemHeldEvent.class, Slot.class, event -> new InventorySlot(event.getPlayer().getInventory(), event.getNewSlot()));
		EventValues.registerEventValue(PlayerItemHeldEvent.class, Slot.class, event -> new InventorySlot(event.getPlayer().getInventory(), event.getPreviousSlot()), TIME_PAST);
		...
		EventValues.registerEventValue(PlayerPickupArrowEvent.class, ItemStack.class, event -> event.getItem().getItemStack());
		...
		if (Skript.classExists("io.papermc.paper.event.player.PlayerStonecutterRecipeSelectEvent"))
			EventValues.registerEventValue(PlayerStonecutterRecipeSelectEvent.class, ItemStack.class, event -> event.getStonecuttingRecipe().getResult());

		// EntityTransformEvent
		EventValues.registerEventValue(EntityTransformEvent.class, Entity[].class, event -> event.getTransformedEntities().stream().toArray(Entity[]::new));
		...
		if (Skript.classExists("org.bukkit.event.block.BellRingEvent")) {
			...
			EventValues.registerEventValue(BellRingEvent.class, Direction.class, event -> new Direction(event.getDirection(), 1));
		...
		if (Skript.classExists("org.bukkit.event.block.BellResonateEvent")) {
			EventValues.registerEventValue(BellResonateEvent.class, Entity[].class, event -> event.getResonatedEntities().toArray(new LivingEntity[0]));
		}
		...
		EventValues.registerEventValue(InventoryMoveItemEvent.class, Block.class, event -> event.getSource().getLocation().getBlock());
		EventValues.registerEventValue(InventoryMoveItemEvent.class, Block.class, event -> event.getDestination().getLocation().getBlock(), TIME_FUTURE);
		...
		// BlockDropItemEvent
		EventValues.registerEventValue(BlockDropItemEvent.class, Block.class, event -> new BlockStateBlock(event.getBlockState()), TIME_PAST);
		EventValues.registerEventValue(BlockDropItemEvent.class, Player.class, BlockDropItemEvent::getPlayer);
		EventValues.registerEventValue(BlockDropItemEvent.class, ItemStack[].class, event -> event.getItems().stream().map(Item::getItemStack).toArray(ItemStack[]::new));
		EventValues.registerEventValue(BlockDropItemEvent.class, Entity[].class, event -> event.getItems().toArray(Entity[]::new));
		...
		EventValues.registerEventValue(PlayerExpCooldownChangeEvent.class, Timespan.class, event -> new Timespan(Timespan.TimePeriod.TICK, event.getNewCooldown()));
		EventValues.registerEventValue(PlayerExpCooldownChangeEvent.class, Timespan.class, event -> new Timespan(Timespan.TimePeriod.TICK, event.getPlayer().getExpCooldown()), TIME_PAST);
		...
		if (Skript.classExists("com.destroystokyo.paper.event.block.BeaconEffectEvent")) {
			EventValues.registerEventValue(BeaconEffectEvent.class, PotionEffectType.class, event -> event.getEffect().getType(), TIME_NOW, "Use 'applied effect' in beacon effect events.", BeaconEffectEvent.class);
