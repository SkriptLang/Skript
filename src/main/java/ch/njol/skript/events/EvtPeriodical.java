...
public class EvtPeriodical extends SkriptEvent {
	...
	static {
		Skript.registerEvent("*Periodical Recurrence", EvtPeriodical.class, ScheduledNoWorldEvent.class, "every %timespan%")
		...
		Skript.registerEvent("*Periodical Recurrence", EvtPeriodical.class, ScheduledEvent.class, "every %timespan% in [realm[s]] %worlds%")
				.description("An event that is called periodically.")
				.examples(
