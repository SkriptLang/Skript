...
public final class EvtEntity extends SkriptEvent {
	...
	static {
		Skript.registerEvent("Demise", EvtEntity.class, EntityDeathEvent.class, "demise [of %-entitydatas%]")
				...
				.since("1.0");
		Skript.registerEvent("Advent", EvtEntity.class, EntitySpawnEvent.class, "spawn[ing] [of %-entitydatas%]")
