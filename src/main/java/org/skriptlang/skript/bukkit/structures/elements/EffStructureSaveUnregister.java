...
public class EffStructureSaveUnregister extends Effect {
	...
	static {
		if (Skript.classExists("org.bukkit.structure.Structure"))
			Skript.registerEffect(EffStructureSaveUnregister.class,
		"(:unregister|delete) structure[s] [with name|named] %strings%",
					"save [structure] %structure% [with name|named] %string%");
	}
