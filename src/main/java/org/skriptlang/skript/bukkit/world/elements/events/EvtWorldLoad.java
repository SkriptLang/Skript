...
public class EvtWorldLoad extends SkriptEvent {
	...
	public static void register(SyntaxRegistry syntaxRegistry) {
		syntaxRegistry.register(BukkitSyntaxInfos.Event.KEY, BukkitSyntaxInfos.Event.builder(EvtWorldLoad.class, "World Load")
			.supplier(EvtWorldLoad::new)
	...
	public boolean check(Event event) {
		...
		WorldLoadEvent worldEvent = (WorldLoadEvent) event;
