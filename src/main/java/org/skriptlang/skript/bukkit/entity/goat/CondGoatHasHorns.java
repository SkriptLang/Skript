...
import org.skriptlang.skript.bukkit.entity.goat.EffGoatHorns.GoatHorn;
...
public class CondGoatHasHorns extends PropertyCondition<LivingEntity> {
	...
	public static void register(SyntaxRegistry registry) {
		registry.register(
			...
			infoBuilder(
				CondGoatHasHorns.class,
				PropertyType.HAVE,
				"((any|a) horn|left:[a] left horn[s]|right:[a] right horn[s]|both:both horns)",
				"livingentities"
			).supplier(CondGoatHasHorns::new)
				.build()
		);
	}
