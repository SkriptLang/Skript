...
@Experimental
@ApiStatus.Internal
public final class FunctionRegistryImpl implements org.skriptlang.skript.common.function.FunctionRegistry {

	private final org.skriptlang.skript.Skript skript;

	public FunctionRegistryImpl(org.skriptlang.skript.Skript skript) {
		this.skript = skript;
	}
