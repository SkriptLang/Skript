...
public class FunctionRegistryTest {
	...
	private static final Function<Void> LOCAL_TEST_FUNCTION_B = DefaultFunction.voidBuilder(Skript.instance(), FUNCTION_NAME)
			.modifiers(new org.skriptlang.skript.common.function.Signature.Modifier.Local(TEST_SCRIPT))
			.parameter("a", Boolean.class)
			.build(b -> {});

	private static final Function<Void> LOCAL_TEST_FUNCTION_N = DefaultFunction.voidBuilder(Skript.instance(), FUNCTION_NAME)
			.modifiers(new org.skriptlang.skript.common.function.Signature.Modifier.Local(TEST_SCRIPT))
			.parameter("a", Number.class)
			.build(b -> {});
